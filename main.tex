...
\begin{document}
    ...
    \section{Experience}
        \cventry{Jun~2023--Aug~2023}{Associate Data Scientist}{Sky}{London}{}{
            \begin{itemize}
                \item Trained a tennis live-stream event detector based on `Multi-modal Self-Supervision from Generalized Data Transformations'.
        ...
        \cventry{Jun~2022--Sep~2022}{Junior Machine Learning Engineer}{Sky}{London}{}{
            \begin{itemize}
                \item Developed automated score detectors for Premier League football and tennis matches using computer vision (OpenCV) and optical character recognition.
                \item Implemented appropriate Python unit tests.
