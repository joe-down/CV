...
\begin{document}
    ...
    \section{Experience}
        \cventry{Jun~2023--Aug~2023}{Associate Data Scientist}{Sky}{London}{}{
            \begin{itemize}
                \item Trained a tennis event detector based on `Multi-modal Self-Supervision from Generalized Data Transformations'.
        ...
        \cventry{Jun~2022--Sep~2022}{Junior Machine Learning Engineer}{Sky}{London}{}{
            \begin{itemize}
                \item Developed automated score detectors for Premier League football and tennis matches using computer vision and optical character recognition.
                \item Dockerised to run on an AWS EC2 instance, taking a video live-stream as input and emitting appropriate score change notifications to Amazon SNS.
            \end{itemize}
        }
    ...
    \section{Education}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item Investigated and questioned the ubiquity of the double descent phenomenon when training a range of neural networks on the MNIST dataset.
                \end{itemize}
    ...
    \section{Skills}
        \cvitem{Programming Languages}{Python, JavaScript/TypeScript, C, C++, C\#, Java, Bash, SQL, Haskell, WebGL, TeX}
        \cvitem{Systems}{Linux (Arch, Nix, Debian), Arduino, Raspberry Pi, Windows, Meta Quest}
        \cvitem{Frameworks}{PyTorch, TensorFlow, Docker, Unity, Node.js, React, PyQt, Flask, Rospy, Nashpy, PettingZoo, OpenCV}
